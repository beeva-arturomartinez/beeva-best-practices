...
| Acction 1                                   |     S                  |    N                  |                        |
| Acction 2                                   |     N                  |    S                  |                        |
| Business Rule 1 requires that all the conditions are true to generate action 1. <br /> 2 business rule is in action 2 if condition1 is false and condition2 is true, but does not depend on condition3.  <br /> Rule 3 requires that business conditions 1 and 2 are true and three false.    |   |           |                    |
