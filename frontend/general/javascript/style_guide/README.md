...
## Modules
  ...
  > Why? Modules are the future, let's start using the future now.
    ...
    ```javascript
    // bad
    const BeevaStyleGuide = require('./BeevaStyleGuide');
    module.exports = BeevaStyleGuide.es6;

    // ok
    import BeevaStyleGuide from './BeevaStyleGuide';
    export default BeevaStyleGuide.es6;

    // best
    import { es6 } from './BeevaStyleGuide';
    export default es6;
    ```
  ...
  > Why? This makes sure you have a single default export.
    ...
    ```javascript
    // bad
    import * as BeevaStyleGuide from './BeevaStyleGuide';
  ...
  > Why? Although the one-liner is concise, having one clear way to import and one clear way to export makes things consistent.
    ...
    // bad
    // filename es6.js
    export { es6 as default } from './BeevaStyleGuide';
...
## Type Casting & Coercion
  ...
  - [21.5](#21.5) <a name='21.5'></a> **Note:** Be careful when using bitshift operations. Numbers are represented as [64-bit values](http://es5.github.io/#x4.3.19), but Bitshift operations always return a 32-bit integer ([source](http://es5.github.io/#x11.7)). Bitshift can lead to unexpected behavior for integer values larger than 32 bits.
...
## Naming Conventions
  ...
  - [22.8](#22.8) <a name='22.8'></a> Use PascalCase when you export a singleton / function library / bare object.
    ...
    ```javascript
    const BeevaStyleGuide = {
      es6: {
      }
    };

    export default BeevaStyleGuide;
    ```
